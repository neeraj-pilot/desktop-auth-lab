...
const String linuxLocalAuthPolkitActionId = 'io.ente.authlab.unlock';
...
policy="\$install_dir/files/share/desktop-auth-lab/data/flutter_assets/assets/polkit/io.ente.authlab.policy"
sudo install -D -o root -g root -m 0644 "\$policy" /usr/share/polkit-1/actions/io.ente.authlab.policy
...
pkaction --action-id $actionId --verbose''';
    ...
    return '''
sudo install -D -o root -g root -m 0644 "$policyAssetPath" /usr/share/polkit-1/actions/io.ente.authlab.policy
if command -v chcon >/dev/null 2>&1; then sudo chcon system_u:object_r:usr_t:s0 /usr/share/polkit-1/actions/io.ente.authlab.policy || true; fi
pkaction --action-id $actionId --verbose''';
  }
}
